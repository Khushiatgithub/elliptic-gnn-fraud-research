# -*- coding: utf-8 -*-
"""
Script to create reproducible deterministic generation scripts in results/figures/scripts/
"""

import os

scripts_dir = 'results/figures/scripts'
os.makedirs(scripts_dir, exist_ok=True)

readme_content = """# Figure Generation Scripts Suite
...
with open(os.path.join(scripts_dir, 'README.md'), 'w', encoding='utf-8') as f:
    f.write(readme_content.strip() + '\n')

print('Wrote results/figures/scripts/README.md')
