...
\begin{itemize}
    ...
    \item For GraphSAGE, retaining unknown nodes degraded test illicit F1 from $0.4132$ to $0.2822$ ($\Delta\text{F1} = -0.1310$), reflecting noise injection during neighborhood aggregation.
\end{itemize}
